...
def get_splag_country(df,kernel_inner=1,kernel_width=1,kernel_power=0,norm_kernel=0):
...
def splag_cm(df,kernel_inner,kernel_width,kernel_power,norm_kernel):
    ...
    distances=utilities._get_country_distances(data_country_ids,data_country_to_index)
    ...
    for month_id in data_month_ids:
        ...
        if month_id in neighb_month_ids:
            ...
            for country_id in data_country_ids:
                ...
                weights=distances[data_country_index,neighbs_data_indices]**kernel_power
...
def splags_to_df(
    ...
    df_column_names=['splag_'+str(kernel_inner)+'_'+str(kernel_outer)+'_'
                     +str(kernel_power)+'_'+str(norm_kernel)+'_'+feature,]
